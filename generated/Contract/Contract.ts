...
export class Contract extends ethereum.SmartContract {
  ...
  try_crowdsaleAddress(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "crowdsaleAddress",
      "crowdsaleAddress():(address)",
      []
  ...
  try_privateSaleWallet(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "privateSaleWallet",
      "privateSaleWallet():(address)",
      []
...
export class SetCrowdsaleAddressCall extends ethereum.Call {
  get inputs(): SetCrowdsaleAddressCall__Inputs {
    return new SetCrowdsaleAddressCall__Inputs(this);
  }

  get outputs(): SetCrowdsaleAddressCall__Outputs {
    return new SetCrowdsaleAddressCall__Outputs(this);
  }
}

export class SetCrowdsaleAddressCall__Inputs {
  _call: SetCrowdsaleAddressCall;

  constructor(call: SetCrowdsaleAddressCall) {
    this._call = call;
  }

  get _crowdsaleAddress(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetCrowdsaleAddressCall__Outputs {
  _call: SetCrowdsaleAddressCall;
...
export class SetPrivateSaleAddressCall extends ethereum.Call {
  get inputs(): SetPrivateSaleAddressCall__Inputs {
    return new SetPrivateSaleAddressCall__Inputs(this);
  }

  get outputs(): SetPrivateSaleAddressCall__Outputs {
    return new SetPrivateSaleAddressCall__Outputs(this);
  }
}

export class SetPrivateSaleAddressCall__Inputs {
  _call: SetPrivateSaleAddressCall;

  constructor(call: SetPrivateSaleAddressCall) {
    this._call = call;
  }

  get _privateSaleWallet(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class SetPrivateSaleAddressCall__Outputs {
  _call: SetPrivateSaleAddressCall;
